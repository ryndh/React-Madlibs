...
class Content extends Component {
    ...
    const stories = {
        ...
        "3":<p>
        Long ago in <b className="madlib-variable">{data.one[1]}</b>, there was a band of <b className="madlib-variable">{`${data.two[1]}s`}</b> who were <b className="madlib-variable">{data.three[1]}</b> hunters. They were <b className="madlib-variable">{data.four[1]}</b> with a bow and arrow, but better with a <b className="madlib-variable">{data.five[1]}</b>. There was a great competition held in which the hunters competed to see who was the most <b className="madlib-variable">{data.six[1]}</b> with a crossbow, <b className="madlib-variable">{data.seven[1]}</b> with a sword, and who was the best at <b className="madlib-variable">{data.eight[1]}</b>. The day of the competition, the king declared that the winner would receive <b className="madlib-variable">{`${data.nine[1]},000`}</b> <b className="madlib-variable">{data.ten[1]}</b>. The competitors were <b className="madlib-variable">{data.eleven[1]}</b> at the announcement. The hunters competed <b className="madlib-variable">{data.twelve[1]}</b> to win the competition, but in the end, Sir <b className="madlib-variable">{data.thirteen[1]}</b> won the competition by <b className="madlib-variable">{data.fourteen[1]}</b> points. True to his word, the king handed over the <b className="madlib-variable">{`${data.nine[1]},000`}</b> <b className="madlib-variable">{data.ten[1]}</b> 
        </p>,
